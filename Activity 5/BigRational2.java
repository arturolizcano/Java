...
public class BigRational2 {
    ...
    public BigRational2(int numerator, int denominator) {
    ...
    // create and initialize a new Rational object
    public BigRational2(BigInteger numerator, BigInteger denominator) {
    ...
    // return a * b
    public BigRational2 times(BigRational2 b) {
        BigRational2 a = this;
        BigInteger numerator   = a.num.multiply(b.num);
        BigInteger denominator = a.den.multiply(b.den);
        return new BigRational2(numerator, denominator);
    }


    // return a + b
    public BigRational2 plus(BigRational2 b) {
        BigRational2 a = this;
    ...
    // return 1 / a
    public BigRational2 reciprocal() { return new BigRational2(den, num);  }

    // return a / b
    public BigRational2 divides(BigRational2 b) {
        BigRational2 a = this;
